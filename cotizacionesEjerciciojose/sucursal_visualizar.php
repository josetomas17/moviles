    ...
    <body>
        ...
        <div class="jumbotron">
                ...
                while ($f = $res->fetch_assoc()) {
                    ...
                    ?>
                    <h1>Mostrar detalles Sucursal</h1>
                    <form role="form" id="login-form" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre_del_proveedor" name="nombre_del_proveedor"
                                   value="<?php echo $f['sucursal_nombre'] ?>" style="text-transform:uppercase;" readonly="">
                        </div>
                        <div class="form-group">
                            <label>Direccion</label>
                            <input type="text" class="form-control" id="direccion_del_proveedor" name="direccion_del_proveedor"
                                   value="<?php echo $f['sucursal_direccion'] ?>" style="text-transform:uppercase;" readonly="">
                        </div>

                        <div class="form-group">
                            <label>Telefono 1</label>
                            <input type="tel" class="form-control" id="telefono_1" name="telefono_1"
                                   value="<?php echo $f['sucursal_telefono'] ?>" style="text-transform:uppercase;" readonly="">
                        </div>

                        <label>Telefono 2</label>
                        <input type="tel" class="form-control" id="telefono_2" name="telefono_2"
                               value="<?php echo $f['sucursal_telefono_2'] ?>" style="text-transform:uppercase;" readonly="">
                        <br>
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="correo_proveedor" name="correo_proveedor"
                                   value="<?php echo $f['sucursal_correo'] ?>" style="text-transform:uppercase;" readonly="">
                        </div>
                        <br>
