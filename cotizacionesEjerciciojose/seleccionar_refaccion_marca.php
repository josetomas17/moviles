                    ...
                    <tbody>
                        <?php while ($f = $res->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td><a href="seleccionar_refaccion.php?marca_id=<?php echo $f['marca_id'] ?>&marca_nombre=<?php echo $f['marca_nombre']?>">Seleccionar <span class="glyphicon glyphicon-hand-left"></span> </td>
                            </tr>
                            <?php
                        }
                        $sel->close();
