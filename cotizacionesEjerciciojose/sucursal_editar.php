        ...
        <div class="jumbotron">
                ...
                while ($f = $res->fetch_assoc()) {
                    ...
                    <form role="form" id="login-form" 
                          ...
                          action="sucursal_editar_guardar.php">
                        <div class="h2">
                            Datos de sucursal
                        </div>
                        <div class="form-group">
                            <label for="id_del_proveedor">Id de la Sucursal (requerido)</label>
                            <input type="text" class="form-control" id="id_proveedor" name="id_proveedor"
                                   value="<?php echo $f['sucursal_id'] ?>" style="text-transform:uppercase;" readonly="">
                        </div>
